...
public class App 
{
    public static String Nombre1[] = new String[20];
    public static String Nombre2[] = new String[20];
    public static String Anho[] = new String[20];
    ...
    //public static void main(String args[]) throws UnsupportedEncodingException, UnirestException {
        ...
        String host = "https://dawn2k-random-german-profiles-and-names-generator-v1.p.rapidapi.com/?count=20&gender=b&maxage=999&minage=100&cc=0&email=0&pwlen=0&ip=0&phone=0&uuid=false&lic=false&color=false&seed=0&images=false&format=json";
        String charset = "UTF-8";
        String x_rapidapi_host = "dawn2k-random-german-profiles-and-names-generator-v1.p.rapidapi.com";
        String x_rapidapi_key = "b99fb4bd09mshb5b49c8945ac9e5p19b783jsnbc6ec45e0f1f";
        String i = "tt0110912";
